...
class SignupComponent extends React.Component {
    ...
    submitSignup = (e) => {
        ...
        // Creating the user and authentication firebase
        // After successfully creating it, add it to database
        firebase
            .auth()
            ...
            .then(authRes => {
                ...
                firebase
                    ...
                    .set(userObj) // setting document = userObj
                    .then(() => {
...
// Adding styles as a property to component
